...
1. Load the given SMPL mesh using trimesh
   2.Create a function calculate_circumference with mesh and target_z as the parameters. 1. Detect the vertical axis using mesh.extents.
   ...
   6.Close the loop using np.vstack and load the circumference using trimesh.load_path for visual representation.
   7.Both the cicumference and the visual loop is returned
